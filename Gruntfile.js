...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/PixiTest.st', 'src/PixiTest-Backend.st', // list all sources in dependency order
                    'src/PixiTest-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-pixitest',
